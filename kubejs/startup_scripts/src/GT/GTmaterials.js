...
GTCEuStartupEvents.registry("gtceu:material", event => {
    ...
    event.create("taranium_powder")
        ...
        .blastTemp(16200)
        .iconSet(GTMaterialIconSet.METALLIC)
        .flags(GTMaterialFlags.GENERATE_ROD, GTMaterialFlags.GENERATE_FRAME, GTMaterialFlags.GENERATE_PLATE, GTMaterialFlags.GENERATE_GEAR, GTMaterialFlags.GENERATE_BOLT_SCREW, GTMaterialFlags.GENERATE_FOIL)
    ...
    event.create("mana_super_plus")
        ...
        .ingot()
        .color(0x0a59a3)
        .element(GTElements.get('mana_super_plus'))
        .liquid()
        .flags(GTMaterialFlags.GENERATE_PLATE, GTMaterialFlags.GENERATE_ROD, GTMaterialFlags.GENERATE_GEAR, GTMaterialFlags.GENERATE_SMALL_GEAR, GTMaterialFlags.GENERATE_BOLT_SCREW, GTMaterialFlags.GENERATE_FOIL, GTMaterialFlags.GENERATE_FRAME, GTMaterialFlags.GENERATE_RING)
    event.create("mana_plus")
        .dust()
        .ingot()
        .color(0x1f6eb8)
        .element(GTElements.get('mana_plus'))
        .liquid()
        .flags(GTMaterialFlags.GENERATE_PLATE, GTMaterialFlags.GENERATE_ROD, GTMaterialFlags.GENERATE_GEAR, GTMaterialFlags.GENERATE_SMALL_GEAR, GTMaterialFlags.GENERATE_BOLT_SCREW, GTMaterialFlags.GENERATE_FOIL, GTMaterialFlags.GENERATE_FRAME, GTMaterialFlags.GENERATE_RING)
    ...
    event.create('sodium22')
        ...
        .color((0x4682B4))
        .radioactiveHazard(3)
    event.create('elf_active_fuel')
        .liquid()
        .color((0x28358A))
    event.create('mana_up_fuel')
        .liquid()
        .color((0x28358A))
    event.create('mana_up_fuel_active')
        .liquid()
        .color((0x28358A))
    event.create('mana_up_fuel_exhausted')
        .liquid()
        .color((0x28358A))
    event.create('starlight_fuel')
        .liquid()
        .color((0XFFC107))
    event.create('starlight_fuel_active')
        .liquid()
        .color((0XFFC107))
    event.create('starlight_fuel_exhausted')
        .liquid()
        .color((0XFFC107))
    event.create('blood_fuel')
        .liquid()
        .color((0XFF0000))
    event.create('blood_fuel_active')
        .liquid()
        .color((0XFF0000))
    event.create('blood_fuel_exhausted')
        .liquid()
        .color((0XFF0000))
    event.create('star_fuel')
        .liquid()
        .color((0XFFD700))
    event.create('star_fuel_active')
        .liquid()
        .color((0XFFD700))
    event.create('star_fuel_exhausted')
        .liquid()
        .color((0XFFD700))
