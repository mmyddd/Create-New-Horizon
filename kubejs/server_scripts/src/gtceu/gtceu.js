...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.neutron_activator("naquadah_process")
        ...
        .duration(100)
        .addCondition($CTNHRecipes.setNA(230, 220))
    ...
    event.recipes.gtceu.dimensional_gas_collection("venus_air1")
        .notConsumable('ad_astra:venus_calorite_ore')
        .circuit(1)
    ...
    event.recipes.gtceu.alloy_smelter('blackiron')
        .itemInputs('4x minecraft:iron_ingot', 'gtceu:graphite_dust')
        .itemOutputs('4x extendedcrafting:black_iron_ingot')
        .EUt(8)
        .duration(400)
    ...
    event.recipes.gtceu.assembly_line('ctnhcore:sculk_cell')
        .itemInputs('32x gtceu:stem_cells', '8x minecraft:sculk_vein', '4x minecraft:sculk', '2x minecraft:echo_shard', 'kubejs:echo_printed_circuit_board', 'gtceu:crystal_soc', 'gtceu:crystal_soc', 'extendedcrafting:crystaltine_ingot', '64x gtceu:hidden_alloy_bolt', '64x gtceu:hidden_alloy_bolt', '64x gtceu:hidden_alloy_bolt', '64x gtceu:hidden_alloy_bolt', 'gtceu:highly_advanced_soc', 'gtceu:highly_advanced_soc', 'gtceu:highly_advanced_soc', 'gtceu:highly_advanced_soc')
    ...
    event.recipes.gtceu.assembly_line('cultivationroom')
        .itemInputs('4x gtceu:tritanium_frame', '32x gtceu:clean_machine_casing', '4x gtceu:sterile_cleanroom_maintenance_hatch', '27x gtceu:fusion_glass', '64x gtceu:stem_cells', '64x gtceu:stem_cells', '64x gtceu:stem_cells', '64x gtceu:stem_cells')
    ...
    event.recipes.gtceu.chemical_reactor('cao')
        ...
        .EUt(30)
        .duration(80)
    event.recipes.gtceu.centrifuge('radon')
        .itemInputs('alexscaves:radon_bottle')
        .itemOutputs('minecraft:bottle')
